...
const CloudBlue = (color = "#5899DA") => {
  return (
    ...
    >
      <circle cx="31" cy="31" r="31" fill="#5899DA" fill-opacity="0.3" />
      <g clipPath="url(#clip0_743_694)">
        <path
