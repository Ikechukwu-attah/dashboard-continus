...
const CardWidget = ({
  ...
  return (
    ...
    >
      ...
      <StyledBox position="absolute" Top="1rem" Right="1rem" cursor="ponter">
        {icon}
      </StyledBox>
      <StyledBox position="absolute" Top="2px" Right="1rem">
        <StyledCircle background={background}>{icon2}</StyledCircle>
      </StyledBox>
    </StyledDivFlex>
  );
};
